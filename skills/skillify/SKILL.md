...
3. Decide whether the workflow belongs as:
   ...
   - documentation only
4. When drafting a file-backed skill, output a complete `SKILL.md` that starts with YAML frontmatter.
   ...
   - Write learned/user/project skills to:
     - `${CLAUDE_CONFIG_DIR:-~/.claude}/skills/omc-learned/<skill-name>/SKILL.md`
     - `.omc/skills/<skill-name>/SKILL.md`
5. Draft the rest of the `SKILL.md` content with clear triggers, steps, and success criteria.
